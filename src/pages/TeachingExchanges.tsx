...
export default function TeachingExchanges() {
  const [viewMode, setViewMode] = useState<ViewMode>("list");
  const items = [
    { title: "学院师生赴意大利参加国际非遗博览会", date: "2025-11-20", summary: "展示荆楚非遗数字化保护成果，与多国非遗传承机构建立合作意向。" },
    { title: "与韩国又松大学签订合作交流协议", date: "2025-09-10", summary: "双方将在师生互访、课程共建、非遗研究等领域开展深度合作。" },
    { title: "承办全国职业院校文旅专业建设研讨会", date: "2025-06-15", summary: "全国80余所职业院校参会，共商文旅专业发展大计。" },
    { title: "教师赴新加坡南洋理工学院访学交流", date: "2025-04-01", summary: "学习国际先进职业教育理念，引进项目化教学改革经验。" },
    { title: "开展'非遗进校园'系列学术讲座10场", date: "2025-02-20", summary: "邀请国家级非遗传承人、行业专家进校开讲，师生反响热烈。" },
    { title: "与省内5所本科院校建立专升本合作通道", date: "2024-10-15", summary: "为学生学历提升搭建桥梁，2025届毕业生专升本升学率提升15%。" },
  ];
    ...
    <div className="min-h-screen bg-heritage-cream">
      <main className="pt-20 pb-20">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle title="学术交流" subtitle="开放合作，互学互鉴" />
