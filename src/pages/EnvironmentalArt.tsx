        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 bg-white rounded-xl shadow-sm border border-heritage-primary/10 p-8 md:p-10">
            ...
            <div className="space-y-5 text-gray-700 leading-loose text-base">
              <p className="indent-8">环境艺术设计专业培养具有艺术素养和设计创新能力的环境艺术设计人才。专业涵盖室内设计、景观设计、展示设计等多个方向，注重理论与实践相结合。</p>
              <p className="indent-8">学生将系统学习空间设计原理、装饰材料与构造、计算机辅助设计等核心课程，掌握从方案构思到施工落地的完整设计流程。</p>
              <p className="indent-8">毕业生可在建筑设计院、室内设计公司、景观规划设计机构、展览展示公司等单位从事环境空间的设计与规划工作。</p>
            </div>
          </div>
          <div className="mt-8 rounded-xl overflow-hidden shadow-lg bg-gradient-to-br from-heritage-primary/20 via-heritage-secondary/20 to-heritage-gold/20 h-72 md:h-96 flex items-center justify-center border border-heritage-primary/10">
            <div className="text-center"><span className="text-7xl">🏛️</span><p className="mt-3 text-heritage-primary/40 text-sm">环境艺术设计 · 专业风采</p></div>
          </div>
        </div>
      </main>
    </div>
